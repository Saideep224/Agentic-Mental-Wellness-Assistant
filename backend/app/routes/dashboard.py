...
# ── suggested-songs and mood average endpoints ─────────────────────
from app.models.emotion_log import EmotionLog

mood_router = APIRouter(prefix="/api", tags=["Mood & Music"])

@mood_router.get("/mood/average")
...
@mood_router.get("/music/suggested-songs")
